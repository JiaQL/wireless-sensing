...
\textbf{Model-based behavior recognition:} These model-based behavior recognition schemes can only be applied to analyze few human behaviors with a specific frequency range, such as walking, jogging, running, breathing and heart beat. These activities can be sensed according to that they can cause signal fluctuates with specific frequencies. To make the system operate well in reality, two typical challenges need to be addressed.
